...
public class View_Lectures_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_lectures_, container, false);


        ((StudentDrawer) getActivity()).getSupportActionBar().setTitle("View Lectures");
